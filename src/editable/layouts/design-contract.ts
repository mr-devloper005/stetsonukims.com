...
export const editableRootStyle = {
  '--slot4-page-bg': '#f3f1e8',
  '--slot4-page-text': '#1d1d1b',
  '--slot4-panel-bg': '#fbe8ce',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#4f4d43',
  '--slot4-soft-muted-text': '#6e6a5a',
  '--slot4-accent': '#9AB17A',
  '--slot4-accent-fill': '#9AB17A',
  '--slot4-accent-soft': '#E4DFB5',
  '--slot4-dark-bg': '#20241d',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#e5dec8',
  '--slot4-cream': '#fbe8ce',
  '--slot4-warm': '#E4DFB5',
  '--slot4-lavender': '#C3CC9B',
  '--slot4-gray': '#f6f4eb',
  '--slot4-body-gradient': 'radial-gradient(circle at 0% 0%, #fbe8ce 0%, #f3f1e8 38%, #eef0e0 100%)',
  '--editable-border': 'rgba(29,29,27,0.12)',
